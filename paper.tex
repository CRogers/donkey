...
%This might need updating based on: http://en.wikipedia.org/wiki/Dependency_grammar and http://en.wikipedia.org/wiki/Phrase_structure_grammar
...
Issue: Stanford is very slow. Loads huge libraries of English statistics
Output: unicode or \TeX
Input: I chose to just put everything in the haskell file, so I could add comments
...
Visser: The constructions studied in this paper can be viewed as adding control elements to the language. A control element is a symbol representing an instruction concerning storage of bits of meaning. Thus, control elements serve to steer semantic processing.
